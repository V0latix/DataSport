...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "fifa_ranking_history | fifa_beach_soccer_world_cup_history | "
            "fifa_futsal_world_cup_history | fifa_women_ranking_history | "
            "fifa_women_world_cup_history | fide_chess_olympiad_history | "
            "world_rugby_ranking_history | rugby_world_cup_history | "
            "ihf_handball_world_championship_history | iihf_ice_hockey_world_championship_history | "
            ...
            "uci_road_nation_ranking_history | "
